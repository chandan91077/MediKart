    ...
    const fetchMedicineDetails = async () => {
      try {
        const response = await axios.post(
          "https://api.prabhatanvik.shop/patient/medicine/details",
                  ...
                  return (
                    <a key={i} href="">
                      <img
                        ...
                        src={`data:${
                          medicine.Image.contentType
                        };base64, ${Buffer.from(medicine.Image.data).toString(
                          "base64"
                        )}`}
                        alt={medicine.Name}
                      />
          ...
          <div className="col-lg-5">
            <div className="d-flex flex-column h-100">
              ...
              <div className="row g-3 mb-4">
                ...
                <div className="col">
                  <button
                    ...
                    onClick={() => handleBuyNow(medicine, 1)}
                  >
                    Buy now
                  </button>
                </div>
              ...
              <dl className="row">
                ...
                <dd className="col-sm-8 mb-3">
                  {medicine.Quantity > 0 ? "Instock" : "Out of stcok"}
                </dd>
              ...
              <p className="lead flex-shrink-0">
                <small>
                  {medicine.Name} offers a comprehensive solution for{" "}
                  {medicine.MedicinalUse}. This medication is designed to cure
                  any pain due to {medicine.MedicinalUse}. Its innovative
                  formula ensures full and safe recovery. Patients may
                  experience headaches and abdominal pain, although they are
                  typically mild and transient. It is recommended to consult
                  your doctor before proceeding with this medicine.This medicine
                  is intended for ages grater than 12 years old. As with any
                  medication, it is crucial to follow the guidelines as per
                  prescribed by your doctor. Always consult with a healthcare
                  professional before starting any new medication. Remember,
                  specific medicine descriptions should adhere to accurate
                  medical information and guidelines, considering individual
                  product details, intended use, dosage, and potential side
                  effects. Always seek professional advice or refer to the
                  product's official information for precise and tailored
                  guidance.
                </small>
              </p>
            </div>
