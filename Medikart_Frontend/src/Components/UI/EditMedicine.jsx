...
export function EditMedicine({ medicine, onUpdate }) {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(
        `https://api.prabhatanvik.shop/pharmacist/editmedResults?medicineName=${medicine.Name}&newPrice=${price}&newDetails=${details}`
      );
  ...
  return (
    <div>
      ...
      <Button colorScheme="teal" size="md" onClick={handleUpdate}>
        Save
      </Button>
