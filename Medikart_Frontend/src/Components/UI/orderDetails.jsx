...
const OrderDetailsPage = () => {
    ...
    const fetchOrderDetails = async () => {
      try {
        const response = await axios.get(
          "https://api.prabhatanvik.shop/patient/orderDetails",
          {
  ...
  const handleCancelOrder = async (orderId) => {
    try {
      const response = await axios.post(
        "https://api.prabhatanvik.shop/order/cancel-order",
        {
          orderId: orderId,
        },
        { withCredentials: true }
  ...
  return (
    <>
      <Navigation pagetitle={"My Orders"} />
      <Sidebar />
      <div className="content">
        <nav
          bg={"white"}
          class="navbar navbar-expand-lg navbar-blue bg-4bbbf3"
          height=" 100px"
        >
            ...
            <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
              <ul class="navbar-nav">
                <li class="nav-item dropdown">
                  ...
                  <ul
                    class="dropdown-menu dropdown-menu-blue"
                  ...
                  >
                    ...
                    <li>
                      <a class="dropdown-item" onClick={() => setFilter("all")}>
                        All Orders
                      </a>
                    </li>
                  </ul>
                    ...
                    <MDBCard style={{ borderRadius: "20px" }}>
                      ...
                      <MDBCardBody className="p-4">
                        ...
                        <div className="d-flex justify-content-between">
                          <p className="text-muted mb-0">
                            Invoice Date :{" "}
                            {new Date(order.dateAdded).toLocaleString("en-US")}
                          </p>
                        </div>
