...
function PharmacistReqs() {
    ...
    const getReqs = async () => {
      try {
        const { data } = await axios.get(
          "https://api.prabhatanvik.shop/admin/applications",
          {
  ...
  const handleAccept = async () => {
    try {
      ...
      await axios.post(
        `https://api.prabhatanvik.shop/admin/applications/accept-registeration/${viewReq._id}`,
        {},
        {
          withCredentials: true,
        }
  ...
  const handleReject = async () => {
    try {
      ...
      await axios.post(
        `https://api.prabhatanvik.shop/admin/applications/reject-registeration/${viewReq._id}`,
        {},
        {
          withCredentials: true,
        }
